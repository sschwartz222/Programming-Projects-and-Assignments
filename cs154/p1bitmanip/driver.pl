...
# Make sure that dlc has not been corrupted
-z "./dlc"
    and  die "$0: ERROR: dlc has become corrupted. You need to restore an intact copy from your svn history before you can run tests again\n";
